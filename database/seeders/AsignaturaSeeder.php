...
class AsignaturaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('asignaturas')->insert([
            ...
            [ 'nombre' => 'Espacio de AcompañamientoArtes','ciclo' => '1','horas' => 3,'anio' => 1,'tipo_ciclo' => 'General' ],
            [ 'nombre' => 'Espacio de AcompañamientoArtes','ciclo' => '1','horas' => 3,'anio' => 2,'tipo_ciclo' => 'General' ],
